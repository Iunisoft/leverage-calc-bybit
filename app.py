        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8 col-xl-6">
                ...
                <p class="text-center text-muted mt-4 small">
                    Fórmula: Leverage = 0.70 / distancia_SL (limitado al máximo del símbolo)
                    <br class="d-none d-md-block">El margen usado siempre será exactamente el indicado
                </p>
            </div>
        </div>
    </div>
            ...
            $('#symbol').select2({
                ...
                ajax: {
                    ...
                    processResults: function(data) {
                        return {
                            results: data.symbols.map(s => ({
                                id: s.symbol,
                                text: s.symbol + ' (' + s.baseCoin + '/' + s.quoteCoin + ')'
                            }))
                        };
                    },
                    cache: true
            ...
            $('#calcForm').on('submit', async function(e) {
                ...
                try {
                    ...
                    resultBox.html(
                        '<h5 class="mb-3">' +
                            dirBadge + ' ' +
                            '<span class="d-inline-block">' + data.symbol + '</span> ' +
                            warnLev +
                        '</h5>' +
                        ...
                        '<div class="highlight-margen">' +
                            ...
                            '<div class="result-item">' +
                                ...
                                '<span class="result-value">' +
                                    data.margen_usado.toFixed(2) + ' USDT ' +
                                    margenBadge +
                                '</span>' +
                            '</div>' +
                        '</div>' +
                        ...
                        '<div class="result-item">' +
                            '<span class="result-label">Leverage teórico</span>' +
                            '<span class="result-value">' + data.leverage_teorico + 'x</span>' +
                        '</div>' +
                        '<div class="result-item">' +
                            '<span class="result-label">Leverage aplicado</span>' +
                            '<span class="result-value">' + data.leverage_final + 'x</span>' +
                        '</div>' +
                        '<div class="result-item">' +
                            '<span class="result-label">Cantidad</span>' +
                            '<span class="result-value">' + data.qty + ' ' + (currentInstrument?.baseCoin || '') + '</span>' +
                        '</div>' +
                        '<div class="result-item">' +
                            '<span class="result-label">Notional</span>' +
                            '<span class="result-value">' + data.notional_usdt + ' USDT</span>' +
                        '</div>' +
                        '<div class="result-item">' +
                            '<span class="result-label">Riesgo real (SL)</span>' +
                            '<span class="result-value">' + data.riesgo_real_usdt + ' USDT</span>' +
                        '</div>' +
                        '<div class="result-item">' +
                            '<span class="result-label">Distancia al SL</span>' +
                            '<span class="result-value">' + data.distancia_sl_pct + '%</span>' +
                        '</div>'
                    ).removeClass('d-none');
...
if __name__ == "__main__":
    print("=" * 60)
    print("  Bybit Futures Calculator (Responsive)")
